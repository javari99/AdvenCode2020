var challengeInput = ["6-9 z: qzzzzxzzfzzzz",
    "2-4 s: xgmsdts",
    "6-7 k: khqpsvk",
    "1-3 k: knkqh",
    "4-11 z: lwnzgzlmpvz",
    ...
    "6-7 v: ckvbtcv"];
var totalTruths = 0;
for (var _i = 0, challengeInput_1 = challengeInput; _i < challengeInput_1.length; _i++) {
    var phrase = challengeInput_1[_i];
    var splitted = phrase.split(':');
    var rules = splitted[0];
    var str = splitted[1].trim();
    var splittedRules = rules.split(' ');
    var letter = splittedRules[1];
    var splittedNumbers = splittedRules[0].split('-');
    var initial = parseInt(splittedNumbers[0]);
    var final = parseInt(splittedNumbers[1]);
